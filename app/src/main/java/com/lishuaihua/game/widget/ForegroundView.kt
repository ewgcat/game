...
import com.lishuaihua.game.util.CommonUtils
import com.lishuaihua.game.controller.CameraHelper
import com.lishuaihua.game.widget.boat.Boat
    ...
    CameraHelper.FaceDetectListener
{
    ...
    private val _width by lazy { (width * 0.2F).toInt() }

    private val _widthOffset by lazy {
        CommonUtils.dip2px(
            context,
            50F
        )
    ...
    private val _heightOffset by lazy {
        CommonUtils.dip2px(
            context,
            150F
        )
